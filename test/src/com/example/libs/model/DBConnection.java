...
public class DBConnection {
	 ...
	 * Connection conn = null; try { //3. Database Connection한다. conn =
	 * DriverManager.getConnection("jdbc:mariadb://192.168.56.4:3306/test", "root",
	 * "root"); }catch(SQLException ex) {
	 * System.out.println("Mariadb cannot connect."); } return conn; }
	 */
